...
export default function Groups(){
    ...
    useEffect(()=>{
        // grab all the users groups to see
    ...
    //when group is selected go to that groups page
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            {/** if no groups have been added to the account */}
            {userGroups.length === 0 ? (
                ...
                <>
                    {/** show the list of the groups the player is apart of */}
